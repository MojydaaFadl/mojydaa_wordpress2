...
$blog_section_title = $espyjobs_options['blog_title'];
$blog_desc = $espyjobs_options['blog_desc'];
$show_blog_author = $espyjobs_options['show_blog_author'];
$show_blog_date = $espyjobs_options['show_blog_date'];
$blog_category = $espyjobs_options['blog_category'];
$content_length = '100';
if($blog_show) {
                ...
                <?php $recent_query = new WP_Query($args);
                    ...
                    ?>
                        ...
                        global $post;
                            ...
                            $image = wp_get_attachment_image_src($post_thumbnail_id, 'espyjobs-blog-thumbnail-img');
